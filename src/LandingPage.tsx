import { Users, Receipt, Calculator, ArrowRight, Shield, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 right-1/3 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-12 md:pt-24 pb-16">
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 text-sm text-blue-200 mb-8">
          <Shield size={14} />
          <span>Cálculos exactos, sin errores de redondeo</span>
        </div>
        
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold leading-tight max-w-4xl mb-6">
          Divide gastos
        ...
        <p className="text-lg md:text-xl text-slate-300 max-w-2xl mb-10 leading-relaxed">
          ...
          La aplicación calcula automáticamente cuánto debe cada quien y genera las 
          transferencias exactas para quedar a mano.
        </p>
        
        <button 
          onClick={onEnter}
          className="group relative bg-blue-600 hover:bg-blue-500 text-white font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5 flex items-center gap-3"
        >
          Comenzar ahora
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Registra cada gasto con su descripción, monto y quién lo pagó. Edita o elimina en cualquier momento.
            </p>
          </div>

          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors sm:col-span-2 lg:col-span-1">
            <div className="bg-indigo-500/20 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
              <BarChart3 size={24} className="text-indigo-400" />
            </div>
            <h3 className="text-lg font-semibold mb-2">Liquidación inteligente</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
      ...
      {/* Footer */}
      <div className="relative z-10 border-t border-white/10 py-6 text-center text-sm text-slate-500">
